...
Here I added an initial token, which will be used to generate the next letter. On the next step, as a token my program will take our token without the first character + new letter.  
* Old token: onegin  
* Next letter: t  
* New token: negint  
